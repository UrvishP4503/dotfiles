...
vim.api.nvim_set_keymap('n', '<leader>xb', ':bdelete<CR>', { noremap = true })
...
-- Key mappings to close splits
vim.api.nvim_set_keymap('n', '<A-v>', ':close<CR>', { noremap = true })
vim.api.nvim_set_keymap('n', '<A-h>', ':close<CR>', { noremap = true })
